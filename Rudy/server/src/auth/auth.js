...
module.exports = (req, res, next) => {
	...
	console.log("je suis ici valeur du header : ", req.headers.authorization)
    ...
    try {
        ...
        return res.status(401).json({ message: "L'utilisateur n'est pas autorisé à accéder à cette ressource.", date: error.message });
